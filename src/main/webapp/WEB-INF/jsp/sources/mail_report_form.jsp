...
<div class="container">
    ...
    <form:form action="/sources/${name}/mailreport" commandName="form" method="post" cssClass="form-horizontal">
        <form:hidden path="id" />
        ...
        <bootstrap:control path="to" label="To">
            <form:input path="to" size="50"/> (comma separated values)
        </bootstrap:control>
        ...
        <bootstrap:control path="reportTitle" label="Report title">
            <form:input path="reportTitle" />
        </bootstrap:control>
